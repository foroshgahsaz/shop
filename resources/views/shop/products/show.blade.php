                ...
                <div class="product-gallery__layout">
                    <div class="product-gallery__main">
                        <div class="product-zoom">
                            <div class="product-zoom__stage" data-open-lightbox role="button" tabindex="0">
                                <img id="productMainImage" src="{{ $mainImage }}" data-zoom="{{ $mainImage }}" alt="{{ $product->name }}">
                        ...
                        <div class="swiper productGalleryThumbs product-gallery-thumbs">
                            <div class="swiper-wrapper">
                                @foreach($images as $index => $image)
                                    @php $url = asset('storage/'.$image->image); @endphp
            ...
            <div class="product-info">
                ...
                <div class="product-info__meta">
                    <div class="product-info__meta-rating">
                        @if($reviewCount)
                            ...
                            <a href="#reviews" class="product-info__reviews">{{ $reviewCount }} دیدگاه</a>
                        @endif
                ...
                @if($product->description)
                    <div class="product-info__section">
                        <p class="product-option-label">توضیحات</p>
                        <div class="prose prose-sm max-w-none text-gray-600">{!! nl2br(e(strip_tags($product->description))) !!}</div>
                    </div>
                @endif
